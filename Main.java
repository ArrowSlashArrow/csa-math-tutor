...
public class Main {
    ...
    private static final List<String> OPTION_LABELS = List.of("Find the n-th prime", "Solve physics equation", "CircleArea", "Exit");
    private static final List<Optional<Solver>> SOLVERS = List.of(Optional.of(Solver.PrimeFinder),
            Optional.of(Solver.EquationSolver),  Optional.of(Solver.CircleArea),Optional.empty());
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Welcome to mathematics brother.");
        while (true) {
